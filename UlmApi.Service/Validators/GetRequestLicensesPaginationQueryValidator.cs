...
{
    public class GetRequestLicensesPaginationQueryValidator : AbstractValidator<GetRequestLicensesPaginationQuery>
    {
        public GetRequestLicensesPaginationQueryValidator()
        {
            RuleFor(p => p.Limit)
